# Generated by Django 4.2.6 on 2024-06-16 17:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleet.servicetype')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_part_sub_service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='fleet.subservice')),
            ],
        ),
        migrations.CreateModel(
            name='VehicleService',
            fields=[
                ...
                ('vehicle_part', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleet.vehiclepart')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('vehicle_parts', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fleet.vehiclepart')),
            ],
        ),
    ]
