...
class User(AbstractUser):
    ...
    user_type = models.CharField(
        max_length=20, choices=USER_TYPES, default='mechanic')
...
class SubService(models.Model):
    SERVICE_CHOICES = [
        ...
        ('Transmission system inspection and repair',
         'Transmission system inspection and repair'),
    ...
    subservice_name = models.CharField(
        max_length=100, choices=SERVICE_CHOICES, default=None)
...
class VehiclePart(models.Model):
    ...
    vehicle_part_sub_service = models.ForeignKey(
...
class Vehicle(models.Model):
    ...
    vehicle_general_condition = models.CharField(
